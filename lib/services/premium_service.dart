...
//     try {
//       print("--- GUMROAD VERIFICATION ---");
//       print("Checking Key: $licenseKey");
//       print("Product ID: $_gumroadProductId");
...
//       print("Gumroad Status: ${response.statusCode}");
...
//       return false;
//     } catch (e) {
//       print("Gumroad API Connection Error: $e");
//       return false;
//     }
//   }
// }
  ...
  Future<bool> redeemCode(String userId, String codeInput) async {
    ...
    try {
      ...
      if (code.contains('-')) {
        ...
        if (await _isGumroadKeyUsed(code)) {
          throw Exception("This license key is already associated with another account.");
        }
