...
import 'package:linguaflow/screens/library/widgets/cards/library_video_card.dart'; // Import your widgets file
...
class ContentSearchDelegate extends SearchDelegate {
  ...
  Widget _buildFilteredList() {
    ...
    final filteredLessons = lessons.where((lesson) {
      ...
      final contentLower = lesson.content.toLowerCase(); // Optional: Search content too
