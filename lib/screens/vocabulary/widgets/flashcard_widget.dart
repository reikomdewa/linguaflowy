...
class _FlashcardState extends State<Flashcard>
  ...
  void initState() {
    ...
    if (_hasVideo) {
      ...
      if (widget.item.status <= 1) {
        _showVideoOnFront = true;
      } else {
        // 2. Older words: 70% Video, 30% Text Only (Harder recall)
        // This makes it dynamic.
        _showVideoOnFront = Random().nextDouble() <= 0.7;
      }
    }
  }
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // --- VIDEO PLAYER LOGIC ---
                            // Case A: Show on Front (70% chance or New Word)
                            if (_hasVideo && _showVideoOnFront)
                              _buildVideoPlayer(),
  ...
  // Extracted Player Widget for cleaner logic
