        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text("Create Conversation", style: theme.textTheme.headlineSmall),
              const SizedBox(height: 20),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Topic (e.g., Business English, Anime)",
                  filled: true,
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(_isUnlimited ? "Unlimited" : "${_memberCount.toInt()}"),
                      Switch(
                        value: _isUnlimited,
              ...
              SwitchListTile(
                ...
                secondary: Icon(FontAwesomeIcons.coins, color: _isPaid ? Colors.amber : Colors.grey),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    // 2. Add Event to Bloc
                    context.read<SpeakBloc>().add(CreateRoomEvent(
                      topic: topic,
                      language: "English", // In future, add a Language Dropdown
                  ...
                  child: const Text("Go Live", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
