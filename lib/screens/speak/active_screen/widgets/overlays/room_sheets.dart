...
class RoomMenuSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // DESKTOP FIX: Align to bottom center and constrain width
    return Align(
      ...
      child: ConstrainedBox(
        ...
        child: Container(
          decoration: const BoxDecoration(
            ...
            // On desktop, we round all corners if it's floating,
            // but standard bottom sheet usually rounds top only.
            // Let's stick to top rounding for consistency.
