...
// This widget provides the white background and Scaffold for mobile.
// ==============================================================================
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      body: SafeArea(
        child: Center(
          // We call the extracted content widget here
...
// This widget holds all the state (controllers, bools) and the Form UI.
// It DOES NOT have a Scaffold, so it can be used inside the Web Layout safely.
// ==============================================================================
...
class _LoginFormContentState extends State<LoginFormContent> {
  ...
  @override
  Widget build(BuildContext context) {
    // Start directly with BlocListener (No Scaffold, No SafeArea)
              ...
              children: [
                ...
                OutlinedButton.icon(
                  onPressed: () {
                    ...
                    print("🔘 BUTTON CLICKED!"); // <--- Add this

                    if (!_acceptedTerms) {
                      print("⚠️ Terms not accepted"); // <--- Add this
                      ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    print(
                      "🚀 Sending AuthGoogleLoginRequested to Bloc...",
                    ); // <--- Add this
