  ...
  void _openDetailDialog(DocumentSnapshot doc) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Row(
          children: [
            Icon(Icons.bug_report, color: _getSeverityColor(data['severity'] ?? 'low')),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _detailRow("Date:", data['createdAt'] != null 
        ...
        actions: [
          ...
          if (status == 'open')
            TextButton(
              ...
              child: const Text("Mark In Progress", style: TextStyle(color: Colors.blue)),
            ),
        ...
        Expanded(
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                ...
                .where('status', whereIn: _filterStatus == 'open' ? ['open', 'in_progress'] : ['resolved'])
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(_filterStatus == 'open' ? "No open bugs!" : "No resolved history."),
                    ],
                  ),
                );
              }
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        ...
                        child: Icon(
                          severity == 'critical' ? Icons.warning : Icons.bug_report, 
                          color: Colors.white
                        ),
                      ),
                      title: Text(
                      ...
                      trailing: Chip(
                        ...
                        backgroundColor: status == 'in_progress' ? Colors.blue : (status == 'resolved' ? Colors.grey : Colors.green),
                      ),
                    ),
                  );
                },
