...
// // Removed mobile specific youtube player
...
//   // --- Media Players ---
//   // Web Controller (Used for Mobile Web and Desktop Web)
//   web.YoutubePlayerController? _webYoutubeController;

//   // MediaKit (Used for direct file links on Web/Desktop)
//   Player? _localPlayer;
...
//   bool _hidePlayerForDialog = false; // Prevents Iframe overlap
...
//     // Removed SystemChrome orientations for Web/Desktop compatibility
...
//     // Note: For Web, local content init via File() is not possible.
//     // Subtitles should be fetched via HTTP or passed as string content.
//     if (hasSubtitleUrl && _activeTranscript.isEmpty) {
//       // logic to fetch subtitles via HTTP would go here
//       // _initializeLocalContent();
//       _finalizeContentInitialization(); // Skipping local file parse for Web safety
//     } else {
...
//     // Hide the player so iframe doesn't block the dialog
...
//     // Simplified logic for Web responsive layout triggers
...
//   // _initializeLocalContent removed as it relied on dart:io File
...
//     } else if (_webYoutubeController != null) {
...
//   // The Manual Stack Overlay for Premium Lock
...
//               youtubeController: null, // Removed mobile controller
//               onToggleFullscreen: _toggleCustomFullScreen,
//             )
//           : AspectRatio(
//               aspectRatio: 16 / 9,
...
//                   // 2. TAP DETECTOR (Web style - let iframe handle clicks mostly)
//                   if (kIsWeb)
//                     Positioned.fill(
//                       child: GestureDetector(
...
//     // This solves the issue where the iframe renders on top of the dialog
...
//       );
//     } else if (_webYoutubeController != null) {
//       // Used for both Mobile Web and Desktop Web
...
//     // We use the variables updated by _checkSync()
//     final double max = _totalDuration.inSeconds.toDouble();
//     final double value = _currentPosition.inSeconds.toDouble().clamp(0.0, max);
...
//     // If the video is longer than an hour, show hours
//     if (d.inHours > 0) {
