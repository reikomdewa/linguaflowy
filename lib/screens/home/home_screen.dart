...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  builder: (context, lessonState) {
                    ...
                    if (lessonState is LessonLoaded) {
                      ...
                      final importedLessons =
                          lessonState.lessons
                              .where((l) => l.type == 'text' && !l.userId.startsWith('system'))
                              .toList();

                      // Identify system books by prefix
                      final libraryLessons = 
                          lessonState.lessons
                              .where((l) => l.type == 'text' && l.userId.startsWith('system'))
                              .toList();
                      ...
                      return RefreshIndicator(
                        ...
                        child: SingleChildScrollView(
                          ...
                          const PracticeBannerButton(),
                              ...
                              // 4. READING LIBRARY (New Section - Horizontal)
  ...
  Widget _buildLibrarySection(
    ...
    // 1. Sort: Beginner first, then others
    lessons.sort((a, b) {
                        ...
                        children: [
                          ...
                          if (isSelected)
                            Container(
                              ...
                              height: 2,
                              width: 20,
                              color: Colors.green, // Differentiate with green
                            ),
                        ],
                      ),
                    ),
  ...
  // Text card used for specific filters
