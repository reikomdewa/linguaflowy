...
//           return Column(
//             children: [
//               // 1. GLOBAL FILTERS (View Modes) - TOP
...
//                             crossAxisAlignment: CrossAxisAlignment.start,
//                             children: [
//                               // 2. GUIDED COURSES (Horizontal + Imported Tab)
//                               _buildGuidedSection(
//                                 guidedLessons,
//                                 importedLessons, // Pass imported lessons here
//                                 vocabMap,
//                                 isDark,
//                                 textColor,
//                               ),

//                               // 3. TRENDING VIDEOS (Vertical + Tabs)
//                               _buildNativeSection(
//                                 nativeLessons,
//                                 vocabMap,
//                                 isDark,
...
//               child: Row(
//                 children: [
//                   // Make the left side flexible so it can shrink if needed
//                   Expanded(
//                     child: Row(
//                       children: [
//                         Icon(Icons.circle, size: 8, color: Colors.blue),
//                         SizedBox(width: 4),
//                         // Allow text to shrink and show ellipsis
//                         Flexible(
//                           child: Text(
//                             "$newCount New",
//                             style: TextStyle(fontSize: 12, color: Colors.grey),
...
//                   // Keep the options button fixed size on the right
//                   IconButton(
...
//     // 2. Get Full Name (fallback to Uppercase code if not found)
//     final fullLangName = langNames[currentLanguage] ?? currentLanguage.toUpperCase();
