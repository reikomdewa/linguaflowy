...
//       // 3. EMIT SUCCESS (This triggers the navigation)
//       emit(LessonGenerationSuccess(newLesson));
      
//       // 4. (Optional) immediately trigger a reload so the background list updates
//       // Note: This might happen too fast for the UI to catch the Success state
//       // strictly speaking, but usually Flutter handles it. 
//       // If navigation fails, remove this line and reload when popping the screen.
//       add(LessonLoadRequested(event.userId, event.targetLanguage));
