...
CURATED_AUDIOBOOKS = {
    ...
    'fr': [('Livre audio français avec texto', 'audiobook'), ('French graded reader', 'audiobook'), ('Le Petit Prince audio', 'classic')],
...
def get_audiobook_details(video_url, lang_code, genre, manual_level=None, max_retries=3, is_pinned=False):
    ...
    # Filter by duration (Audiobooks are generally longer)
